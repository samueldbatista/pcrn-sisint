...
$(document).ready(function () {
    ...
    //
    // $('#tarefas-servico').click(function () {
    //     $('#myModal').modal();
    // });

    // console.log("teste de javascropt");
    // var servico = $(this).find('#data-fechamento-servico').val();
    // console.log(servico);
    // $('#btn-salvar').click(function () {
    //     var titulo = $("input[name = 'servico.titulo']");
    //     var descricao = $("input[name = 'servico.descricao']");
    ...
    //     obj.dataFechamento = dataFechamento;
    //
    //     var url =$('#urlSalvarServicos').val();
    //
    // });
